...
func mountPulls(page *mizu.Router, d Deps) {
	...
	pg.Get("/{owner}/{repo}/pull/{number}/commits/{sha}", ph.CommitRedirect)
	pg.Get("/{owner}/{repo}/pull/{number}/files", ph.Files)
	pg.Get("/{owner}/{repo}/pull/{number}/files/expand", ph.ExpandDiff)
...
func mountRepoSettings(page *mizu.Router, d Deps) {
	...
	rg.Post("/{owner}/{repo}/settings", rh.UpdateGeneral)
	rg.Post("/{owner}/{repo}/settings/visibility", rh.UpdateVisibility)
	rg.Post("/{owner}/{repo}/settings/delete", rh.Delete)
